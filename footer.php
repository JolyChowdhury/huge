            ...
            <div class="footer-top">
                <div class="row align-items-center">
                    <div class="col-lg-5 col-md-5">
                        <div class="ft-left">
                            <div class="ft-left-img">
                               <img src="<?php print template_url(); ?>assets/image/logo/ft-logo.png" alt="ftl-logo">
                            </div>
                            <div class="ft-left-text">
                                <h4>Join now and get 10 % off on your next Purchase</h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3">
                        <div class="ft-middle">
                            <p>Subscribe to our weekly newsletter and receive exclusive offers you love!!</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="fm-left">
                            <div class="fm-left-logo">
                                <img src="<?php print template_url(); ?>assets/image/logo/head-logo.webp" alt="fm-logo">
                            </div>
                            <div class="fm-left-text">
                                <p>Use this text to enter footer text.</p>
                                <p>Huge is a quick-launch value concept that is optimized for success. <a href="#">Learn More</a>.<br><br></p>
                                <span>Call Us :<a href="tel:+1 234 567 890">+1 234 567 890</a></span>
                            </div>
                            <div class="fm-social">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-sm-6">
                    <div class="footer-btm-left">
                        <p>&copy; 2023 Huge Theme | Powered by Shopify</p>
                    </div>
                </div>
                <div class="col-lg-6 col-sm-6">
...
<script>
    ...
    $(document).ready(function() {
        ...
        <!-- Main Script -->
        <script type="text/javascript" src="<?php print template_url('assets/js/script.js'); ?>"></script>
